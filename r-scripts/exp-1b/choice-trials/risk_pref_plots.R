...
# Save Plot
ggsave("plots/exp-1b/choice-trials/plt_risky_blk.png",
  plot = plt_risky_blk,
  units = "in", width = 11, height = 7,
  dpi = 500
)

ggsave("plots/exp-1b/choice-trials/plt_risky_blk.svg",
  plot = plt_risky_blk,
  units = "in", width = 11, height = 7
)
...
# Save Plot
ggsave("plots/exp-1b/choice-trials/plt_risky_int.png",
       plot = int_plot,
       units = "in", width = 9, height = 7,
       dpi = 500
)

ggsave("plots/exp-1b/choice-trials/plt_risky_int.svg",
       plot = int_plot,
       units = "in", width = 9, height = 7
)
