...
include_graphics(
  file.path(main_dir,"plots/exp-1a/choice-trials/plt_risky_blk.png")
)
```
...
```{r, out.width = '60%'}
include_graphics(
  file.path(main_dir,"plots/exp-1a/choice-trials/plt_risky_bar.png")
)
```
...
<details>
  <summary>
  Plot - Interaction plot with 95% CIs (Blocks 5 & 6)
  </summary>
...
```{r, out.width = '60%'}
include_graphics(
  file.path(main_dir,"plots/exp-1a/choice-trials/plt_risky_int.png")
)
```
...
<details>
  <summary>
  Summary Stats for Extreme-Outcome Scores
  </summary>
  
<br>

```{r}
kable(diffs_summary, 'html', digits = 4) %>%
